...
language: en
author: "Blazej Kunke"
tags: ["AI", "Anthropic", "Fable 5", "Mythos 5", "AI Strategy", "European AI"]
...
My most recent write up on the Polish language test is here: [Fable 5 po polsku: dwa livestreamy dla początkujących](/blog/fable-5-polski-livestream/).

The [full playlist on Fable 5 and Mythos testing](https://www.youtube.com/playlist?list=PLih5mUCujWAhOc48bsuM39dnS1YP-SKXo) lives on YouTube.
...
If your team wants to use AI in a way that is practical, grounded, and not hostage to a single provider, let's talk. Email my sales team at [jan.kunke@kunkeconsulting.pl](mailto:jan.kunke@kunkeconsulting.pl) and we'll work out how ^Kunke Consulting can help.

## Subscribe and follow the story

If you want to watch the testing, the breakdowns, and whatever happens next with Fable, Mythos, and the European alternatives, [subscribe to the channel](https://www.youtube.com/@BlazeAdventuresWorld).
